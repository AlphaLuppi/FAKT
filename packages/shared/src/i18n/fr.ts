...
export const fr = {
  ...
  quotes: {
    ...
    ai: {
      tabText: "Coller un brief",
      tabFile: "Déposer un fichier",
      tabTextHint: "Texte libre, email, copier-coller depuis un échange.",
      tabFileHint: "PDF, DOCX, MD, TXT ou EML — extraction automatique du texte.",
      ...
      dropzoneTitle: "Glisse un fichier ici, ou clique pour choisir",
      dropzoneFormats: "Formats acceptés : PDF · DOCX · TXT · MD · EML",
      fileCardParsing: "Lecture en cours…",
      fileCardReady: "Prêt à analyser",
      fileCardError: "Erreur de lecture",
      fileCardRemove: "Retirer",
      fileCardSize: (n: number) => `${(n / 1024).toFixed(0)} Ko`,
      extract: "Extraire avec l'IA",
      extracting: "Claude analyse le contenu…",
      cancel: "Annuler",
      noContentHint: "Ajoute du texte ou un fichier pour lancer l'extraction.",
      ...
      extractedSubtitle: "Vérifie et corrige avant de créer le devis.",
      extractedClient: "Client proposé",
      extractedClientName: "Nom du client",
      extractedClientEmail: "Email du client",
      extractedItems: "Lignes proposées",
      extractedItemDescription: "Description",
      extractedItemQuantity: "Qté",
      extractedItemUnit: "Unité",
      extractedItemPrice: "Prix unitaire (€)",
      extractedItemRemove: "Supprimer",
      extractedItemAdd: "+ Ajouter une ligne",
      extractedNotes: "Notes",
      extractedNotesPlaceholder: "Notes à reporter sur le devis (optionnel)",
  ...
  imports: {
    ...
    subtitle:
      "Charge un devis signé ou une facture déjà payée hors FAKT pour compléter ton historique. Ces documents n'occupent pas la séquence officielle.",
    badge: "IMPORTÉ",
    backToList: "Retour",
    typeLabel: "Type de document",
    typeQuote: "Devis signé",
    typeQuoteHint: "Devis accepté/signé hors FAKT",
    typeInvoice: "Facture payée",
    typeInvoiceHint: "Facture déjà émise et payée",
    sourceTitle: "Source",
    sourceTabFile: "Déposer un fichier",
    sourceTabText: "Coller du texte",
    sourceFileHint: "PDF, DOCX, MD, TXT — l'IA extraira automatiquement les champs.",
    sourceTextHint: "Colle le contenu textuel du document si tu n'as pas le PDF.",
    extract: "Extraire avec l'IA",
    extracting: "Claude analyse le document…",
    cancel: "Annuler",
    fillTitle: "Compléter les informations",
    fillSubtitle: "L'IA a pré-rempli ce qu'elle a trouvé. Vérifie et corrige avant de valider.",
    externalNumberLabel: "Numéro d'origine",
    externalNumberPlaceholder: "ex : DEVIS-2024-CASA",
    externalNumberHint: "Le numéro qui figure sur le PDF d'origine. Optionnel.",
    issuedAtLabel: "Date d'émission",
    signedAtLabel: "Date de signature",
    paidAtLabel: "Date de paiement",
    paymentMethodLabel: "Mode de règlement",
    paymentMethodWire: "Virement",
    paymentMethodCheck: "Chèque",
    paymentMethodCash: "Espèces",
    paymentMethodOther: "Autre",
    paymentNotesLabel: "Notes paiement",
    titleLabel: "Titre",
    clientLabel: "Client",
    submitQuote: "Importer le devis",
    submitInvoice: "Importer la facture",
    successQuote: "Devis importé avec succès.",
    successInvoice: "Facture importée avec succès.",
    errorClientRequired: "Sélectionne un client avant d'importer.",
    errorTitleRequired: "Le titre est obligatoire.",
    errorItemsRequired: "Au moins une ligne est requise.",
    errorSubmit: "L'import a échoué.",
    legalNotice:
      "Ce document est marqué « IMPORTÉ ». Il n'occupe pas la séquence FAKT (CGI art. 289) et n'est pas signé électroniquement par FAKT.",
    listTriggerLabel: "Importer un document existant",
  },
