...
describe("getQuote", () => {
  beforeEach(() => createQuote(db, { id: QUOTE_ID, workspaceId: WORKSPACE_ID, clientId: CLIENT_ID_1, title: "D", totalHtCents: 0, items: [] }));
...
describe("listQuotes", () => {
  beforeEach(() => {
    createQuote(db, { id: QUOTE_ID, workspaceId: WORKSPACE_ID, clientId: CLIENT_ID_1, title: "A", totalHtCents: 0, items: [] });
    createQuote(db, { id: QUOTE_ID_2, workspaceId: WORKSPACE_ID, clientId: CLIENT_ID_1, title: "B", totalHtCents: 0, items: [] });
  });
  ...
  it("trie les items par position", () => {
    const ITEM_A = { id: "20000000-0000-0000-0000-000000000010", position: 1, description: "B", quantity: 1000, unitPriceCents: 10000, unit: "heure" as const, lineTotalCents: 10000, serviceId: null };
    const ITEM_B = { id: "20000000-0000-0000-0000-000000000011", position: 0, description: "A", quantity: 1000, unitPriceCents: 10000, unit: "heure" as const, lineTotalCents: 10000, serviceId: null };
    const QUOTE_MULTI = "10000000-0000-0000-0000-000000000099";
    createQuote(db, { id: QUOTE_MULTI, workspaceId: WORKSPACE_ID, clientId: CLIENT_ID_1, title: "Multi-items", totalHtCents: 20000, items: [ITEM_A, ITEM_B] });
...
describe("updateQuote", () => {
  beforeEach(() => createQuote(db, { id: QUOTE_ID, workspaceId: WORKSPACE_ID, clientId: CLIENT_ID_1, title: "Old", totalHtCents: 0, items: [] }));
...
describe("deleteQuote", () => {
  it("supprime un draft", () => {
    createQuote(db, { id: QUOTE_ID, workspaceId: WORKSPACE_ID, clientId: CLIENT_ID_1, title: "D", totalHtCents: 0, items: [] });
...
describe("searchQuotes", () => {
  beforeEach(() => {
    createQuote(db, { id: QUOTE_ID, workspaceId: WORKSPACE_ID, clientId: CLIENT_ID_1, title: "Site vitrine Hotel", totalHtCents: 0, items: [] });
    createQuote(db, { id: QUOTE_ID_2, workspaceId: WORKSPACE_ID, clientId: CLIENT_ID_1, title: "Formation React", totalHtCents: 0, items: [] });
  });
